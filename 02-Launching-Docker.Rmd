...
In some situations, the link above may give you an error message: 
...
If this happens, simply use the code below:

~~~
docker run --rm -e PASSWORD=password -p 8787:8787 rocker/rstudio
~~~
...
~~~
docker run --rm -e PASSWORD=password -p 8787:8787 -v /Users/tiffanytimbers/Documents/DC/r-docker-tutorial:/home/rstudio/r-docker-tutorial rocker/rstudio
~~~
