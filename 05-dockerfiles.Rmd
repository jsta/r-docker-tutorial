...
## Challenge Questions 
 - Write a Dockerfile that makes an image like the one you made at the end of Section 3: built on `rocker/hadleyverse`, with `gapminder` and `gsl` installed. Also add a readme to your image describing what it contains.
