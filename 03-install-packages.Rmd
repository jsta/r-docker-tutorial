...
You can install R packages with your RStudio, like you would on a desktop-RStudio-session. The image below shows RStudio server running within a docker image.
