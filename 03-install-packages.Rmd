...
You can install R packages with RStudio in the browser, like you would on a desktop-RStudio-session. The image below shows RStudio server running within a docker image.
